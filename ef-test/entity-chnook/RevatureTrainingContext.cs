...
{
    public partial class RevatureTrainingContext : DbContext
    {
        public RevatureTrainingContext()
        {
        }

        public RevatureTrainingContext(DbContextOptions<RevatureTrainingContext> options)
            : base(options)
        {
        }
